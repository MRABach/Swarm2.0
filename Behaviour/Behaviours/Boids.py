...
class boidBehavior():
    ...
    def __call__(self, position, movement, global_list):
        ...
        list_dist_3d = [] # En liste med lister av distanser til fartoy
        ...
        sim_speed = 1
        sim_bearing = 1
        #bearing som burde få simonsviken avstotningsvektoren til å gå mer sor-vest
        #sim_bearing = 310
       ...
       # print(test)
            ...
            ais_content = boat
            ais_dict = ais_content.asdict() # Gjor den dekodede meldingen om til en dict så den kan brukes i koden
            #print(ais_dict)
            ...
            # print(ais_dict)
                #Filter for å få bort fartoy langt unna
        ...
        for list in list_vec_3d:
            for obj in list:
                # Henter ut distansen fra eget fartoy til det aktuelle fartoyet / aliaset
